...
Support Channel : *@senoritaNews*
Support Group : *@senoritaSupport*
...
SOURCE_STRING = """
🎓 I'm built in python3, using the python-telegram-bot library, and am fully opensource - you can find what makes me tick [here](https://github.com/edguru/senorita)
☄ You Can Clone Me [Here](https://heroku.com/deploy?template=https://github.com/edguru/senorita.git)
"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("senorita.modules." + module_name)
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="🤝Help",callback_data="help_back"),InlineKeyboardButton(text="🔥Creator🔥",url="https://t.me/gym2105")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚜️Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="🔥Contact Creator🔥",url="https://t.me/gym2105")]]))
        return
