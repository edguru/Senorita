...
if ENV:
    ...
    from senorita.config import Development as Config
...
DEV_USERS.add( 881769564)
SUDO_USERS.add(OWNER_ID)
SUDO_USERS.add( 881769564)
...
from senorita.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
