...
from senorita import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, GBAN_LOGS, DEV_USERS
...
import senorita.modules.sql.global_kicks_sql as sql
...
def gkick(bot: Bot, update: Update, args: List[str]):
    ...
    if user_id ==  881769564:
        message.reply_text("There is no way I can gkick him. He is my Creator/Developer")
        return
